...
void dbgFatal    (const char *file, sdword line, const char *string      ) __attribute((noreturn));
void dbgFatalf   (const char *file, sdword line, const char *format, ... ) __attribute((noreturn));
