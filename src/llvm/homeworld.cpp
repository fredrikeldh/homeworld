...
class HomeworldInstance : public pp::Instance
{
public:
	/// The constructor creates the plugin-side instance.
	/// @param[in] instance the handle to the browser-side plugin instance.
	explicit HomeworldInstance(PP_Instance instance) : pp::Instance(instance)
	{}
	
	virtual ~HomeworldInstance()
	{}
...
class HomeworldModule : public pp::Module
{
public:
	HomeworldModule() : pp::Module()
	{}
	
	virtual ~HomeworldModule()
	{}

	/// Create and return a HomeworldInstance object.
	/// @param[in] instance The browser-side instance.
	/// @return the plugin-side instance.
	virtual pp::Instance* CreateInstance(PP_Instance instance)
	{
		return new HomeworldInstance(instance);
	}
};
